...
import { UserPlus, Mail, Lock, User, Loader2, Shield, Activity, Fingerprint, Cpu, ShieldCheck } from "lucide-react";
      ...
      <div className="w-full max-w-[440px] space-y-10">
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-4xl font-black title-tech tracking-tight uppercase leading-none">
              CREATE <span className="title-tech-red italic">ACCOUNT</span>
            </h1>
          </div>
        </motion.div>
        ...
        <GlassCard className="!p-10 border-white/[0.03]">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              <label className="text-[13px] font-black uppercase tracking-wide text-zinc-600 flex items-center justify-between">
                ...
                <span className="opacity-40 font-mono text-sm">STR_01</span>
              </label>
              <input
                type="text"
                value={name}
                ...
                className="w-full bg-zinc-950 border border-border rounded p-3 text-xs font-mono focus:border-primary/50 outline-none transition-colors placeholder:text-zinc-800 text-white"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 mt-2 rounded bg-primary text-white font-black text-xs tracking-wide uppercase hover:brightness-110 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
            >
              {loading ? (
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            <span className="text-[12px] font-black text-zinc-600 uppercase tracking-widest">or</span>
            <div className="flex-1 h-px bg-zinc-800" />
          </div>
        ...
        <div className="mt-6 flex items-center justify-center gap-4 text-zinc-700">
           <div className="flex items-center gap-1">
             <Fingerprint size={12} />
             <span className="text-[12px] font-mono">Secure</span>
           </div>
